...
import com.example.SpringBootResTfulJUnitMockitoHamcrestEclEmmaApplication;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes=SpringBootResTfulJUnitMockitoHamcrestEclEmmaApplication.class)
@SpringBootTest
...
public class ToDoControllerTest {
	...
	public void verifySaveToDo() throws Exception {
		System.out.println("JSON!!!!!!!!!!! {\"text\" : \"New ToDo Sample\", \"completed\" : \"false\" }");
